...
/**
 * ContactDialogueCaseBaseWithIds
 */
public class ContactDialogueCaseBaseWithIds   {
  private String contactDialogueRecordReference = null;

  private String contactDialogueCaseTaskReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return contactDialogueCaseTaskReference
  **/

  public String getContactDialogueCaseTaskReference() {
    return contactDialogueCaseTaskReference;
  }

  public void setContactDialogueCaseTaskReference(String contactDialogueCaseTaskReference) {
    this.contactDialogueCaseTaskReference = contactDialogueCaseTaskReference;
  }

...
/**
 * ContactDialogueOrderBaseWithIds
 */
public class ContactDialogueOrderBaseWithIds   {
  private String contactDialogueRecordReference = null;

  private String contactDialogueOrderTaskReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return contactDialogueOrderTaskReference
  **/

  public String getContactDialogueOrderTaskReference() {
    return contactDialogueOrderTaskReference;
  }

  public void setContactDialogueOrderTaskReference(String contactDialogueOrderTaskReference) {
    this.contactDialogueOrderTaskReference = contactDialogueOrderTaskReference;
  }

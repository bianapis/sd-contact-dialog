...
/**
 * ContactDialogueRecordRequest
 */
public class ContactDialogueRecordRequest   {
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info:  \"Employee or unit assigned to the servicing position\" 
